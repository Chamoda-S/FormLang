...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_form_spec = 13,                 /* form_spec  */
  YYSYMBOL_form_body = 14,                 /* form_body  */
  YYSYMBOL_section = 15,                   /* section  */
  YYSYMBOL_field_list = 16,                /* field_list  */
  YYSYMBOL_field = 17                      /* field  */
};
...
static const char *const yytname[] =
{
  ...
  "FIELD", "IDENTIFIER", "STRING_LITERAL", "COLON", "SEMICOLON", "LBRACE",
  "RBRACE", "$accept", "form_spec", "form_body", "section", "field_list",
  "field", YY_NULLPTR
};
...
{
       6,     1,    13,     4,     5,     3,     6,    10,    17,    19,
      12,     9,    13,    11,    16,    20,     0,     0,     0,    21,
       0,     0,     0,     0,     0,    18
};

static const yytype_int8 yycheck[] =
{
       4,     3,     5,     0,    10,     6,     4,    11,    11,     8,
      10,     7,     5,     7,     6,     6,    -1,    -1,    -1,     9,
      -1,    -1,    -1,    -1,    -1,    14
};
...
{
       0,     3,    13,     6,     0,    10,     4,    14,    15,     7,
      11,    15,    10,     5,    16,    17,     6,    11,    17,     8,
       6,     9
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* form_spec: FORM IDENTIFIER LBRACE form_body RBRACE  */
#line 32 "parser.y"
                                             {
          sprintf(html,
            "<!DOCTYPE html>\n"
...
#line 1403 "parser.tab.c"
  ...
  case 3: /* form_body: form_body section  */
#line 82 "parser.y"
                     {
        char *buf = malloc(strlen((yyvsp[-1].str)) + strlen((yyvsp[0].str)) + 1);
        strcpy(buf, (yyvsp[-1].str)); strcat(buf, (yyvsp[0].str));
        (yyval.str) = buf;
...
#line 1414 "parser.tab.c"
  ...
  case 4: /* form_body: section  */
#line 88 "parser.y"
             { (yyval.str) = (yyvsp[0].str); }
#line 1420 "parser.tab.c"
    break;

  case 5: /* section: SECTION STRING_LITERAL LBRACE field_list RBRACE  */
#line 92 "parser.y"
                                                    {
...
#line 1446 "parser.tab.c"
  ...
  case 8: /* field: FIELD IDENTIFIER COLON IDENTIFIER SEMICOLON  */
#line 109 "parser.y"
                                                {
        char *buf = malloc(2048);

        if (strcmp((yyvsp[-3].str), "fullName") == 0)
